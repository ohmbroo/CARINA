...
// CARINA - SMTP settings 
//
//  Either use 
//          config/config_DEV.php
//  or
//          config/config_HOSTED.php
//   as 
//          config.php
//  to send e-mails.
...
//  SMTP Setting for hosted site GoDaddy.com.
define("EMAIL_USE_SMTP", true);
...
// Carina local development settings - Kept here for record.
...
// FOR GoDaddy Hosted Site - EMAIL_PASSWORDRESET_URL
define("EMAIL_PASSWORDRESET_URL", "http://ivpcl-drastic.org/CARINA/password_reset.php");
 ...
 */
//define("EMAIL_PASSWORDRESET_URL", "http://127.0.0.1/CARINA/register.php");
// FOR GoDaddy Hosted Site - EMAIL_PASSWORDRESET_URL
define("EMAIL_VERIFICATION_URL", "http://ivpcl-drastic.org/CARINA/register.php");
