...
////////////////////////////////////////////////////////////////////////////////
//
//  Module:  translations/lang.en.php
//
...
$lang['MESSAGE_CAPTCHA_WRONG'] = 'Captcha code was wrong!';
$lang['MESSAGE_COOKIE_INVALID'] = 'Invalid cookie';
$lang['MESSAGE_DATABASE_ERROR'] = 'Database connection problem.';
$lang['MESSAGE_EMAIL_ALREADY_EXISTS'] = "This email address is already registered. Please use the \"I forgot my password\" page if you don't remember your credentials.";
$lang['MESSAGE_EMAIL_CHANGE_FAILED'] = 'Sorry, your email change failed.';
$lang['MESSAGE_EMAIL_CHANGED_SUCCESSFULLY'] = 'Your email address has been changed successfully. Your new email address is ';
...
$lang['MESSAGE_LOGIN_FAILED'] = 'You have entered in incorrect username or password.';
...
$lang['MESSAGE_PASSWORD_WRONG'] = 'You have entered in incorrect username or password.';
$lang['MESSAGE_PASSWORD_WRONG_3_TIMES'] = 'You have entered an incorrect username or password 3 or more times already. Please wait 30 seconds to try again.';
...
$lang['MESSAGE_CONSTELLATION_INTRO'] = "The Carina constellation is in the southern sky, meaning \"the keel of a ship.\"  Carina contains the second brightest star in the night sky.";
...
$lang['MESSAGE_MISSION_2'] = 'The astronomical field is in need of this type of collaborative 
                            ...
                            understand the dynamics of the sun that lead to coronal mass ejections.';
// views
...
$lang['LANGUAGE_FLAG_TRADITIONAL'] = 'CHINESE (TRAD.)';
$lang['LANGUAGE_FLAG_CHINESE'] = 'CHINESE (SIMP.)'; 
$lang['LANGUAGE_FLAG_PINYIN'] = 'CHINESE (PINYIN)';
//  SERVICES PAGE
...
$lang['WORDING_BROWSE_FOR_IMAGE'] = 'Annotate Uploaded Images';
$lang['WORDING_BROWSE_IMAGE_DESCRIPTION'] = " - Select an image in the gallery to annotate.";
...
$lang['WORDING_HELP_WHAT_IS_DETAILS'] = 'Our sun\'s corona is not uniform. Darker, cooler parts 
                                    of the corona are known as coronal holes. In these coronal 
                                    holes, there are lower gas and energy levels than the 
                                    surrounding area. Because of this, the sun\'s magnetic field 
                                    will, arch causing solar particles to escape the sun in the
                                    form of solar wind. If coronal holes become big enough, coronal 
                                    mass ejections can occur, which is bad news for us on Earth.';
...
$lang['WORDING_HELP_WHAT_DOES_DETAILS'] = 'Carina utilizes the large userbase of the internet to study, analyze,
                                 and, most importantly, annotate images of the sun to make records of 
                                 ...
                                 understanding solar weather in order to protect our satellites, power and communication 
                                 systems, and other vital electronic systems.';
$lang['WORDING_HELP_HOW_DO'] = 'How do I start?';
$lang['WORDING_HELP_HOW_DO_DETAILS'] = 'You start by creating a free account. From here you can log in and access the
...
$lang['WORDING_HELP_ANNOTATE_DETAILS'] = 'Clicking on the Browse Album to Select Image link or Browse Album to
                                          ...
                                          tool. From there, you can select an image to annotate and begin looking 
                                          ...
                                          annotations. Showing connections on the waypoints is helpful to seeing 
...
$lang['WORDING_HELP_COMMUNICATE_DETAILS'] = 'What better way to get help and questions answered than communicating
                                             with peers? The collaboration link on the services tab will take you to 
                                             the collaboration page with a link to access the #carina chatroom on the 
                                             right hand side. The chatroom will pop out in a new window. From there, 
                                             you can use an auto-generated nickname, or make your own unique nickname. While 
                                             online, you can speak with others in the main chatroom, or exchange 
                                             private messages with other users. Click HERE to launch the #carina IRC Chatroom.';
...
// CONTACT US TAB
$lang['WORDING_CONTACT_TAB_TITLE'] = "Contact Us";
$lang['WORDING_CONTACT_FORM'] = "Contact Form";
$lang['WORDING_CONTACT_NAME'] = "Name:";
$lang['WORDING_CONTACT_EMAIL'] = "E-mail:";
$lang['WORDING_CONTACT_MESSAGE'] = "Message:";
$lang['WORDING_CONTACT_CLEAR'] = "Clear";
$lang['WORDING_CONTACT_SEND'] = "Send";
// FOOTER
